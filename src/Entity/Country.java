...
//    private PriceStrategy oldMemory = new PriceStrategy_OldMemory();
    ...
    private Product amphetamine = new Product(drugType, "Amphetamine", secondsOfClock, 7);
    private Product acid = new Product(drugType, "Acid", tenPercent, 5);
    ...
    private Product gun = new Product(weaponType, "Beretta92F", basePrice, 10);
